/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 2437300645a90540da3fac9748df9967)
// Runtime types generated with workerd@1.20260820.1 2026-08-21 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	HYPERDRIVE: Hyperdrive;
	QUEUE: Queue;
	RL_REQUEST_IP: RateLimit;
	RL_SIGN_IN_SUBJECT: RateLimit;
	RL_SIGN_IN_IP: RateLimit;
	RL_SIGNUP_SUBJECT: RateLimit;
	RL_SIGNUP_IP: RateLimit;
	RL_VERIFY_IP: RateLimit;
	RL_INVITE_IP: RateLimit;
	RL_UPLOAD_SESSION: RateLimit;
	RL_RESET_SUBJECT: RateLimit;
	RL_RESET_IP: RateLimit;
	RL_RESET_VERIFY_IP: RateLimit;
	RL_PASSWORD_SESSION: RateLimit;
	RL_EMAIL_CHANGE_SESSION: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "STORAGE_TRANSPORT" | "PINGRAM_NOTIFICATION_TYPE" | "PINGRAM_BASE_URL" | "PINGRAM_FROM_NAME" | "PINGRAM_FROM_ADDRESS" | "AUTH_SECRET" | "AUTH_COOKIE_SAME_SITE" | "FRONTEND_ORIGINS" | "FIRST_SUPER_ADMIN_EMAIL" | "FIRST_SUPER_ADMIN_SECRET" | "IDENTIFIER_SECRET" | "ROLE_INVITE_SECRET" | "PORTAL_BASE_URL">> {}
}
