...
ALTER TABLE "seb_partner_bank_outcome" ADD CONSTRAINT "seb_partner_bank_outcome_supersedes_fk" FOREIGN KEY ("referral_id","supersedes_outcome_id") REFERENCES "public"."seb_partner_bank_outcome"("referral_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_partner_bank_referral" ADD CONSTRAINT "seb_partner_bank_referral_referred_by_user_id_core_user_id_fk" FOREIGN KEY ("referred_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_partner_bank_referral" ADD CONSTRAINT "seb_partner_bank_referral_deleted_by_user_id_core_user_id_fk" FOREIGN KEY ("deleted_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_partner_bank_referral" ADD CONSTRAINT "seb_partner_bank_referral_submission_fk" FOREIGN KEY ("application_id","submission_id") REFERENCES "public"."seb_application_submission"("application_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_partner_bank_referral" ADD CONSTRAINT "seb_partner_bank_referral_review_fk" FOREIGN KEY ("application_id","desk_review_id") REFERENCES "public"."seb_desk_review"("application_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_partner_bank_referral_version" ADD CONSTRAINT "seb_partner_bank_referral_version_referral_id_seb_partner_bank_referral_id_fk" FOREIGN KEY ("referral_id") REFERENCES "public"."seb_partner_bank_referral"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_partner_bank_referral_version" ADD CONSTRAINT "seb_partner_bank_referral_version_changed_by_user_id_core_user_id_fk" FOREIGN KEY ("changed_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_programme_decision" ADD CONSTRAINT "seb_programme_decision_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_programme_decision" ADD CONSTRAINT "seb_programme_decision_correction_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("correction_reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_programme_decision" ADD CONSTRAINT "seb_programme_decision_recorded_by_user_id_core_user_id_fk" FOREIGN KEY ("recorded_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_programme_decision" ADD CONSTRAINT "seb_programme_decision_submission_fk" FOREIGN KEY ("application_id","submission_id") REFERENCES "public"."seb_application_submission"("application_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_programme_decision" ADD CONSTRAINT "seb_programme_decision_bank_outcome_fk" FOREIGN KEY ("application_id","bank_outcome_id") REFERENCES "public"."seb_partner_bank_outcome"("application_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_programme_decision" ADD CONSTRAINT "seb_programme_decision_supersedes_fk" FOREIGN KEY ("application_id","supersedes_decision_id") REFERENCES "public"."seb_programme_decision"("application_id","id") ON DELETE restrict ON UPDATE no action;
...
ALTER TABLE "seb_application_qualifying_award" ADD CONSTRAINT "seb_application_qualifying_award_created_by_user_id_core_user_id_fk" FOREIGN KEY ("created_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_qualifying_award" ADD CONSTRAINT "seb_application_qualifying_award_cancelled_by_user_id_core_user_id_fk" FOREIGN KEY ("cancelled_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_qualifying_award" ADD CONSTRAINT "seb_application_qualifying_award_case_application_fk" FOREIGN KEY ("funding_case_id","application_id") REFERENCES "public"."seb_application"("funding_case_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_qualifying_award" ADD CONSTRAINT "seb_application_qualifying_award_case_award_fk" FOREIGN KEY ("funding_case_id","current_funding_award_id") REFERENCES "public"."seb_funding_award"("funding_case_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_qualifying_award_version" ADD CONSTRAINT "seb_application_qualifying_award_version_changed_by_user_id_core_user_id_fk" FOREIGN KEY ("changed_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_qualifying_award_version" ADD CONSTRAINT "seb_application_qualifying_award_version_link_case_fk" FOREIGN KEY ("qualifying_award_link_id","funding_case_id") REFERENCES "public"."seb_application_qualifying_award"("id","funding_case_id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_qualifying_award_version" ADD CONSTRAINT "seb_application_qualifying_award_version_case_award_fk" FOREIGN KEY ("funding_case_id","funding_award_id") REFERENCES "public"."seb_funding_award"("funding_case_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_award_assessment" ADD CONSTRAINT "seb_award_assessment_funding_award_id_seb_funding_award_id_fk" FOREIGN KEY ("funding_award_id") REFERENCES "public"."seb_funding_award"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_award_assessment" ADD CONSTRAINT "seb_award_assessment_assessed_by_user_id_core_user_id_fk" FOREIGN KEY ("assessed_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_award_assessment" ADD CONSTRAINT "seb_award_assessment_utilization_obligation_fk" FOREIGN KEY ("funding_award_id","utilization_obligation_id") REFERENCES "public"."seb_utilization_obligation"("funding_award_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_disbursement" ADD CONSTRAINT "seb_disbursement_funding_award_id_seb_funding_award_id_fk" FOREIGN KEY ("funding_award_id") REFERENCES "public"."seb_funding_award"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_disbursement" ADD CONSTRAINT "seb_disbursement_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_disbursement" ADD CONSTRAINT "seb_disbursement_recorded_by_user_id_core_user_id_fk" FOREIGN KEY ("recorded_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_disbursement" ADD CONSTRAINT "seb_disbursement_related_award_fk" FOREIGN KEY ("funding_award_id","related_disbursement_id") REFERENCES "public"."seb_disbursement"("funding_award_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_funding_award" ADD CONSTRAINT "seb_funding_award_funding_case_id_seb_funding_case_id_fk" FOREIGN KEY ("funding_case_id") REFERENCES "public"."seb_funding_case"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_funding_award" ADD CONSTRAINT "seb_funding_award_deleted_by_user_id_core_user_id_fk" FOREIGN KEY ("deleted_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_funding_award" ADD CONSTRAINT "seb_funding_award_case_application_fk" FOREIGN KEY ("funding_case_id","application_id") REFERENCES "public"."seb_application"("funding_case_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_funding_award_version" ADD CONSTRAINT "seb_funding_award_version_funding_award_id_seb_funding_award_id_fk" FOREIGN KEY ("funding_award_id") REFERENCES "public"."seb_funding_award"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_funding_award_version" ADD CONSTRAINT "seb_funding_award_version_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_funding_award_version" ADD CONSTRAINT "seb_funding_award_version_changed_by_user_id_core_user_id_fk" FOREIGN KEY ("changed_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_utilization_obligation" ADD CONSTRAINT "seb_utilization_obligation_release_fk" FOREIGN KEY ("funding_award_id","release_disbursement_id") REFERENCES "public"."seb_disbursement"("funding_award_id","id") ON DELETE restrict ON UPDATE no action;
...
ALTER TABLE "seb_programme_cycle_assessment_rule" ADD CONSTRAINT "seb_programme_cycle_assessment_rule_version_fk" FOREIGN KEY ("programme_cycle_id","programme_cycle_version") REFERENCES "public"."seb_programme_cycle_version"("programme_cycle_id","version") ON DELETE restrict ON UPDATE no action;
...
ALTER TABLE "seb_programme_cycle_identifier_rule" ADD CONSTRAINT "seb_programme_cycle_identifier_rule_version_fk" FOREIGN KEY ("programme_cycle_id","programme_cycle_version") REFERENCES "public"."seb_programme_cycle_version"("programme_cycle_id","version") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_programme_cycle_reason" ADD CONSTRAINT "seb_programme_cycle_reason_version_fk" FOREIGN KEY ("programme_cycle_id","programme_cycle_version") REFERENCES "public"."seb_programme_cycle_version"("programme_cycle_id","version") ON DELETE restrict ON UPDATE no action;
...
ALTER TABLE "seb_recovery_case" ADD CONSTRAINT "seb_recovery_case_application_id_seb_application_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."seb_application"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_case" ADD CONSTRAINT "seb_recovery_case_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_case" ADD CONSTRAINT "seb_recovery_case_opened_by_user_id_core_user_id_fk" FOREIGN KEY ("opened_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_case" ADD CONSTRAINT "seb_recovery_case_deleted_by_user_id_core_user_id_fk" FOREIGN KEY ("deleted_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_case" ADD CONSTRAINT "seb_recovery_case_application_award_fk" FOREIGN KEY ("application_id","funding_award_id") REFERENCES "public"."seb_funding_award"("application_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_case_version" ADD CONSTRAINT "seb_recovery_case_version_recovery_case_id_seb_recovery_case_id_fk" FOREIGN KEY ("recovery_case_id") REFERENCES "public"."seb_recovery_case"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_case_version" ADD CONSTRAINT "seb_recovery_case_version_changed_by_user_id_core_user_id_fk" FOREIGN KEY ("changed_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_entry" ADD CONSTRAINT "seb_recovery_entry_recovery_case_id_seb_recovery_case_id_fk" FOREIGN KEY ("recovery_case_id") REFERENCES "public"."seb_recovery_case"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_entry" ADD CONSTRAINT "seb_recovery_entry_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_entry" ADD CONSTRAINT "seb_recovery_entry_recorded_by_user_id_core_user_id_fk" FOREIGN KEY ("recorded_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_recovery_entry" ADD CONSTRAINT "seb_recovery_entry_related_case_fk" FOREIGN KEY ("recovery_case_id","related_entry_id") REFERENCES "public"."seb_recovery_entry"("recovery_case_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_assignment_event" ADD CONSTRAINT "seb_application_assignment_event_application_id_seb_application_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."seb_application"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_assignment_event" ADD CONSTRAINT "seb_application_assignment_event_from_user_id_core_user_id_fk" FOREIGN KEY ("from_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_assignment_event" ADD CONSTRAINT "seb_application_assignment_event_to_user_id_core_user_id_fk" FOREIGN KEY ("to_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_assignment_event" ADD CONSTRAINT "seb_application_assignment_event_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_application_assignment_event" ADD CONSTRAINT "seb_application_assignment_event_actor_user_id_core_user_id_fk" FOREIGN KEY ("actor_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
...
ALTER TABLE "seb_desk_review" ADD CONSTRAINT "seb_desk_review_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_desk_review" ADD CONSTRAINT "seb_desk_review_reviewed_by_user_id_core_user_id_fk" FOREIGN KEY ("reviewed_by_user_id") REFERENCES "public"."core_user"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_desk_review" ADD CONSTRAINT "seb_desk_review_submission_fk" FOREIGN KEY ("application_id","submission_id") REFERENCES "public"."seb_application_submission"("application_id","id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_desk_review_check" ADD CONSTRAINT "seb_desk_review_check_desk_review_id_seb_desk_review_id_fk" FOREIGN KEY ("desk_review_id") REFERENCES "public"."seb_desk_review"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "seb_desk_review_identifier" ADD CONSTRAINT "seb_desk_review_identifier_desk_review_id_seb_desk_review_id_fk" FOREIGN KEY ("desk_review_id") REFERENCES "public"."seb_desk_review"("id") ON DELETE restrict ON UPDATE no action;
...
ALTER TABLE "seb_revision_request" ADD CONSTRAINT "seb_revision_request_reason_category_id_seb_programme_cycle_reason_id_fk" FOREIGN KEY ("reason_category_id") REFERENCES "public"."seb_programme_cycle_reason"("id") ON DELETE restrict ON UPDATE no action;
...
CREATE INDEX "seb_application_assignment_idx" ON "seb_application" USING btree ("assigned_to_user_id","status","status_changed_at");
...
CREATE UNIQUE INDEX "seb_partner_bank_referral_active_application_uq" ON "seb_partner_bank_referral" USING btree ("application_id") WHERE "seb_partner_bank_referral"."status" = 'OPEN' AND "seb_partner_bank_referral"."deleted_at" IS NULL;
CREATE INDEX "seb_partner_bank_referral_application_idx" ON "seb_partner_bank_referral" USING btree ("application_id","created_at");
CREATE UNIQUE INDEX "seb_partner_bank_referral_version_number_uq" ON "seb_partner_bank_referral_version" USING btree ("referral_id","version");
CREATE UNIQUE INDEX "seb_programme_decision_number_uq" ON "seb_programme_decision" USING btree ("application_id","decision_number");
CREATE UNIQUE INDEX "seb_programme_decision_one_correction_uq" ON "seb_programme_decision" USING btree ("supersedes_decision_id");
CREATE INDEX "seb_programme_decision_application_idx" ON "seb_programme_decision" USING btree ("application_id","created_at");
...
CREATE UNIQUE INDEX "seb_application_qualifying_award_current_award_uq" ON "seb_application_qualifying_award" USING btree ("current_funding_award_id");
CREATE INDEX "seb_application_qualifying_award_case_idx" ON "seb_application_qualifying_award" USING btree ("funding_case_id","status","updated_at");
CREATE UNIQUE INDEX "seb_application_qualifying_award_version_number_uq" ON "seb_application_qualifying_award_version" USING btree ("qualifying_award_link_id","version");
CREATE UNIQUE INDEX "seb_award_assessment_award_number_uq" ON "seb_award_assessment" USING btree ("funding_award_id","assessment_type","assessment_number") WHERE "seb_award_assessment"."utilization_obligation_id" IS NULL;
CREATE UNIQUE INDEX "seb_award_assessment_utilization_number_uq" ON "seb_award_assessment" USING btree ("funding_award_id","utilization_obligation_id","assessment_number") WHERE "seb_award_assessment"."utilization_obligation_id" IS NOT NULL;
CREATE INDEX "seb_award_assessment_latest_idx" ON "seb_award_assessment" USING btree ("funding_award_id","assessment_type","utilization_obligation_id","assessment_number");
CREATE UNIQUE INDEX "seb_disbursement_award_sequence_uq" ON "seb_disbursement" USING btree ("funding_award_id","sequence_number");
CREATE INDEX "seb_disbursement_award_occurred_idx" ON "seb_disbursement" USING btree ("funding_award_id","occurred_at");
CREATE INDEX "seb_funding_award_case_idx" ON "seb_funding_award" USING btree ("funding_case_id","sanction_date") WHERE "seb_funding_award"."deleted_at" IS NULL;
CREATE INDEX "seb_funding_award_status_idx" ON "seb_funding_award" USING btree ("status","updated_at") WHERE "seb_funding_award"."deleted_at" IS NULL;
CREATE UNIQUE INDEX "seb_funding_award_version_number_uq" ON "seb_funding_award_version" USING btree ("funding_award_id","version");
CREATE INDEX "seb_utilization_obligation_due_idx" ON "seb_utilization_obligation" USING btree ("funding_award_id","due_at");
...
CREATE UNIQUE INDEX "seb_programme_cycle_assessment_rule_type_uq" ON "seb_programme_cycle_assessment_rule" USING btree ("programme_cycle_id","programme_cycle_version","assessment_type");
CREATE INDEX "seb_programme_cycle_event_cycle_idx" ON "seb_programme_cycle_event" USING btree ("programme_cycle_id","created_at");
CREATE UNIQUE INDEX "seb_programme_cycle_identifier_rule_kind_uq" ON "seb_programme_cycle_identifier_rule" USING btree ("programme_cycle_id","programme_cycle_version","kind");
CREATE UNIQUE INDEX "seb_programme_cycle_reason_code_uq" ON "seb_programme_cycle_reason" USING btree ("programme_cycle_id","programme_cycle_version","context","code");
CREATE UNIQUE INDEX "seb_programme_cycle_reason_cycle_id_uq" ON "seb_programme_cycle_reason" USING btree ("programme_cycle_id","id");
CREATE UNIQUE INDEX "seb_recovery_case_award_id_uq" ON "seb_recovery_case" USING btree ("funding_award_id","id");
CREATE UNIQUE INDEX "seb_recovery_case_active_award_uq" ON "seb_recovery_case" USING btree ("funding_award_id") WHERE "seb_recovery_case"."status" IN ('OPEN', 'DEMANDED', 'PARTIALLY_SETTLED') AND "seb_recovery_case"."deleted_at" IS NULL;
CREATE INDEX "seb_recovery_case_status_idx" ON "seb_recovery_case" USING btree ("status","updated_at");
CREATE INDEX "seb_recovery_case_award_idx" ON "seb_recovery_case" USING btree ("funding_award_id","created_at");
CREATE UNIQUE INDEX "seb_recovery_case_version_number_uq" ON "seb_recovery_case_version" USING btree ("recovery_case_id","version");
CREATE UNIQUE INDEX "seb_recovery_entry_sequence_uq" ON "seb_recovery_entry" USING btree ("recovery_case_id","sequence_number");
CREATE INDEX "seb_recovery_entry_case_occurred_idx" ON "seb_recovery_entry" USING btree ("recovery_case_id","occurred_at");
CREATE UNIQUE INDEX "seb_application_assignment_event_version_uq" ON "seb_application_assignment_event" USING btree ("application_id","assignment_version");
CREATE INDEX "seb_application_assignment_event_application_idx" ON "seb_application_assignment_event" USING btree ("application_id","created_at");
...
CREATE UNIQUE INDEX "seb_desk_review_submission_uq" ON "seb_desk_review" USING btree ("submission_id");
CREATE INDEX "seb_desk_review_application_idx" ON "seb_desk_review" USING btree ("application_id","reviewed_at");
CREATE UNIQUE INDEX "seb_desk_review_check_type_uq" ON "seb_desk_review_check" USING btree ("desk_review_id","check_type");
CREATE UNIQUE INDEX "seb_desk_review_identifier_kind_uq" ON "seb_desk_review_identifier" USING btree ("desk_review_id","kind");
CREATE INDEX "seb_desk_review_identifier_match_idx" ON "seb_desk_review_identifier" USING btree ("kind","comparable_value","funding_case_id");
