...
| Bank authority | TTM considers bank appraisal and reaches the programme decision. | Both recommended and not-recommended outcomes proceed to TTM. A bank outcome alone never rejects the application. | Aligned with source |
...
| Approval amount | The source does not expressly discuss approving more than requested. | TTM approval cannot exceed the exact requested amount in the frozen submission. | Conservative portal safeguard |
| Release approval | TTM approves releases. | One atomic staff action records the TTM approval evidence and the actual payment entry. | Intentional user-approved product decision |
...
- Partner-bank feedback is recorded as evidence, not treated as the final
  authority.
- TTM records approval, rejection, deferral, or a section-specific revision.
- A sanction is created only from the latest effective approval, and release
  evidence retains the TTM reference.
...
- Corrections append new evidence. Previous submissions, bank outcomes, TTM
